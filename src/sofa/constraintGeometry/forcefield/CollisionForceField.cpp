#include <sofa/constraintGeometry/forcefield/CollisionForceField.h>
...
//            helper::WriteAccessor<DataVecDeriv> force_1 = collision[i].first->getState()->write(fId);
...
//            helper::WriteAccessor<defaulttype::Vector3> force_2 = collision[i].second->getState()->write(f);
...
//template<class DataTypes>
//void CollisionForceField<DataTypes>::addToMatrix(BaseMatrix * /*M*/) {
...
template<class DataTypes>
void CollisionForceField<DataTypes>::draw(const core::visual::VisualParams *flag) {
...
int CollisionForceFieldClass = core::RegisterObject("CollisionForceField")
.add<CollisionForceField<defaulttype::Vec3dTypes> >();
